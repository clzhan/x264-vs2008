 ...
 *****************************************************************************/
	...
	int  mk_startFrame( mk_Writer *w );	/* 开始帧 */
	int  mk_addFrameData( mk_Writer *w, const void *data, unsigned size );	/* 增加帧数据 */
	int  mk_setFrameFlags( mk_Writer *w, int64_t timestamp, int keyframe );	/* 设置帧标志 */
	int  mk_close( mk_Writer *w );	/* 关闭 */
