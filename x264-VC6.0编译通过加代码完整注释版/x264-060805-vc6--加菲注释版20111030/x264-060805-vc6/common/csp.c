 ...
 * x264也支持了RGB24,RGB32及YUVU,YV12等格式,但是支持的意思就是x264里面把这些格式转换成了I420了,具体转换工作在csp.c(Color Space Converter)里完成
 *****************************************************************************
...
void x264_csp_init( int cpu, int i_csp, x264_csp_function_t *pf )	//第2个参数是结构体的指针
{
    switch( i_csp )
    {
        case X264_CSP_I420:
        ...
        default:
            /* For now, can't happen(1. 发生2. 产生结果, 发生作用3. 碰巧, 恰巧) */
